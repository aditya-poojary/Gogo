...
const ContactPage = () => {
  return (
    <ContactPageContainer
      maxWidth="lg"
      id="contact-us"
      className="pt-[87px] bg-white px-6"
    >
      <SectionTitle variant="h4" sx={{ fontWeight: "bold" }}>
        Reach Out <span className="text-orange-500">Us</span>{" "}
      </SectionTitle>
      ...
      <ContactBox>
        ...
        <ContactInfoContainer>
          <SectionTitle variant="h5" sx={{ fontWeight: "medium" }}>
            Contact Us
          </SectionTitle>
